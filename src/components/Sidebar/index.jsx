            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink to={`/${userProfile.data?.data.data.role}/dashboard`} className={({ isActive }) =>
                          ...
                          <li>
                            <NavLink to={`/${userProfile.data?.data.data.role}/member`} className={({ isActive }) =>
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                              (isActive && '!text-blue-500')
                            }>
                              Member
                          ...
                          <li>
                            <NavLink to={`/${userProfile.data?.data.data.role}/manager`} className={({ isActive }) =>
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                              (isActive && '!text-blue-500')
                            }>
                              Manager
                          ...
                          <li>
                            <NavLink to={`/${userProfile.data?.data.data.role}/payment`} className={({ isActive }) =>
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                              (isActive && '!text-blue-500')
                            }>
                              Payment
                          ...
                          <li>
                            <NavLink to={`/${userProfile.data?.data.data.role}/report`} className={({ isActive }) =>
                              'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                              (isActive && '!text-blue-500')
                            }>
                              Report
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) => `group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 
                  ${pathname.includes('calendar') && 'bg-graydark dark:bg-meta-4  !text-blue-500'
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/documents' || pathname.includes('documents')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/documents' ||
