      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4  ">
          ...
          <button
            ...
            onClick={(e) => {
              e.stopPropagation();
              navigate(`${userProfile.data?.data.data.role}/dashboard`)
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <img src={LogoIcon} alt="Logo" className='hidden' />
            <div className='text-teal-600 text-xl font-bold'>{import.meta.env.VITE_APP_NAME}</div>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          ...
          {/* <!-- User Area --> */}
          <ChangePassword isPasswordChanging={isPasswordChanging} setIsPasswordChanging={setIsPasswordChanging} />
          <DropdownUser isPasswordChanging={isPasswordChanging} setIsPasswordChanging={setIsPasswordChanging} />
          {/* <!-- User Area --> */}
        </div>
      </div>
    </header>
