...
const MenuGroup = () => {
  ...
  const links = [
    ...
    },
    {
      path: '/admin/manager',
      name: "MANAGER",
      icon: <TbUserShield className='text-4xl' />
    },
    {
      path: '/admin/payment',
      name: "PAYMENT",
...
const CardGroup = () => {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      <CardDataStats title="Total revenue this month " total="₹5,50,000" rate="0.5%" levelUp>
        <svg
      ...
      <CardDataStats title="Total sold land" total="22L sq<sup>m</sup>" rate="4.35%" levelUp>
        <svg
          className="fill-primary dark:fill-white"
          width="20"
          height="22"
      ...
      <CardDataStats title="Lan Under Preparation" total="200K sq<sup>m</sup>" rate="2.59%" levelUp>
        <svg
          className="fill-primary dark:fill-white"
          width="22"
          height="22"
        ...
        >
          <path
            ...
            fill="#FF0000"
          />
          <circle cx="11" cy="15" r="5" fill="#5500FF" />

        </svg>
      </CardDataStats>
      <CardDataStats title="Total no. of Buyer" total="4,570" rate="0.95%" levelDown>
        <svg
          className="fill-primary dark:fill-white"
          width="22"
          height="18"
